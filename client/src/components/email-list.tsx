...
function SwipeableEmailItem({
  ...
  const isInDraftsOrSent = currentFolder && (currentFolder.systemType === 'drafts' || currentFolder.systemType === 'sent');
        ...
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex-1 md:flex-none flex justify-start">
            {isSelectionMode && selectedEmails.size > 0 ? (
              // For drafts, sent, and spam, only show delete button
      ...
      <div className="flex-1 overflow-auto overflow-x-hidden scroll-custom">
        {currentEmails.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              {(filterBy !== 'all' || sortBy !== 'date' || selectedTagFilter || searchQuery) 
